...
const PrivacyPolicy = ({transferPage}) => {
    useEffect(()=>{
        transferPage()
    }, [])
    return (
        ...
        <section>
            <div className="header">
                itc-app.site（以下，サブドメインの有無を問わず「当サイト」といいます。）は，当サイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
            </div>
        </section>
        <section>
            <div className="header">第1条（個人情報）</div>
            「個人情報」とは，個人情報保護法にいう「個人情報」を指すものとし，生存する個人に関する情報であって，当該情報に含まれる氏名，生年月日，住所，電話番号，連絡先その他の記述等により特定の個人を識別できる情報及び容貌，指紋，声紋にかかるデータ，及び健康保険証の保険者番号などの当該情報単体から特定の個人を識別できる情報（個人識別情報）を指します。
        </section>
        <section>
            <div className="header">第2条（個人情報の収集方法）</div>
        ...
        <section>
            <div className="header">第3条（個人情報を収集・利用する目的）</div>
        ...
        <section>  
            <div className="header">第4条（利用目的の変更）</div>
        ...
        <section>
            <div className="header">第5条（個人情報の第三者提供）</div>
        ...
        <section>
            <div className="header">第6条（個人情報の開示）</div>
        ...
        <section>
            <div className="header">第7条（個人情報の訂正および削除）</div>
        ...
        <section>
            <div className="header">第8条（個人情報の利用停止等）</div>
        ...
        <section>
            <div className="header">第9条（プライバシーポリシーの変更）</div>
            本ポリシーの内容は，法令その他本ポリシーに別段の定めのある事項を除いて，ユーザーに通知することなく，変更することができるものとします。
            当サイトが別途定める場合を除いて，変更後のプライバシーポリシーは，本ウェブサイトに掲載したときから効力を生じるものとします。
        </section>
        <section>
            <div className="header">第10条（お問い合わせ窓口）</div>
            本ポリシーに関するお問い合わせは，下記の窓口までお願いいたします。

            <div>メインウェブサイト：<a href="https://itc-app.site/contact/" target="_blank">https://itc-app.site/</a></div>
            <div>Eメールアドレス：admin@itc.tokyo</div>
            以上
        </section>
        </div>
    )
